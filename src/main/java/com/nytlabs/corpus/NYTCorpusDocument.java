...
public class NYTCorpusDocument {
	...
	/**
	 * The ÔdatelineÕ field is the dateline of the article. Generally a dateline
	...
	/**
	 * The ÔdescriptorsÕ field specifies a list of descriptive terms drawn from
	...
	/**
	 * The Ôgeneral online descriptorsÕ field specifies a list of descriptors
	...
	/**
	 * The Ôlead ParagraphÕ field is the lead paragraph of the article.
	...
	/**
	 * The ÔlocationsÕ field specifies a list of geographic descriptors drawn
	...
	/**
	 * The ÔnamesÕ field specifies a list of names mentioned in the article.
	 ...
	 * be specified as a Ô;Õ delineated list.
	 */
	...
	/**
	 * This field specifies the date of the articleÕs publication.
	 */
	 ...
	 * ÔAlternative UrlÕ field is preferred to this field on articles published
